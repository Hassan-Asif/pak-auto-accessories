  ...
  <main>
    <section class="relative min-h-[calc(100vh-4rem)] overflow-hidden">
      ...
      <div class="container-page relative flex min-h-[calc(100vh-4rem)] items-center py-16">
        <div class="max-w-2xl">
          <p class="text-sm font-bold uppercase tracking-wide text-red-200">Pakistan car accessories</p>
          <h1 class="mt-4 text-5xl font-black leading-tight sm:text-6xl">Premium accessories confirmed before you pay.</h1>
          <p class="mt-5 text-lg text-zinc-300">Place an order, we confirm vendor availability, contact you on WhatsApp, then purchase, pack, and deliver.</p>
    ...
    <section class="container-page grid gap-8 py-16 lg:grid-cols-2">
      <div>
        ...
        <h2 class="mt-2 text-3xl font-black">A confirmation-first model</h2>
        <p class="mt-4 text-zinc-400">Most accessories are vendor-sourced after confirmation. That protects customers from paying for unavailable items and keeps pricing lean.</p>
      </div>
    ...
    <section class="bg-white py-16 text-zinc-950">
      <div class="container-page">
        ...
        <div class="mt-8 grid gap-4 md:grid-cols-3">
          <blockquote v-for="review in reviews" :key="review.name" class="rounded-lg border border-zinc-200 p-5">
...
const why = ['Availability labels stay conservative and confirmation-based.', 'WhatsApp confirmation before any non-COD payment.', 'Vendor sourcing keeps catalog broader and fresher.', 'Admin dashboard tracks products, orders, and statuses.']
const reviews = [
